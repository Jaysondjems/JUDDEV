  ...
  try {
    ...
    if (count === 0) {
      await Service.insertMany([
        ...
        { id: 'desktop-app', title: 'Application Desktop', subtitle: 'Logiciels puissants pour Windows, Mac et Linux', icon: '🖥️', image: 'images/dev1.jpg', shortDesc: "Nous concevons et développons des applications desktop robustes, performantes et intuitives pour toutes les plateformes.", longDesc: "JUDDEV CORPORATION développe des applications de bureau sur mesure répondant aux besoins métier les plus exigeants.", features: ['Applications Windows, Mac & Linux', 'Interfaces graphiques modernes (GUI)', 'Accès aux ressources système (fichiers, réseau, matériel)', 'Synchronisation avec des services cloud', 'Mise à jour automatique', 'Installation et packaging professionnel', 'Support et maintenance continue'], technologies: ['Electron', 'Python (PyQt, Tkinter)', 'C# (.NET / WPF)', 'Java (JavaFX)', 'Rust (Tauri)', 'C++'], category: 'desktop', order: 9 },
        { id: 'cybersecurite', title: 'Cybersécurité', subtitle: 'Protégez votre infrastructure numérique', icon: '<i class="fas fa-shield-halved"></i>', image: 'images/ia.jpg', shortDesc: 'Audit, protection et surveillance de vos systèmes informatiques contre les cybermenaces pour garantir la sécurité de vos données.', longDesc: "JUDDEV CORPORATION vous accompagne dans la sécurisation de votre infrastructure numérique. Notre équipe d'experts effectue des audits complets, identifie les vulnérabilités et met en place des mesures de protection robustes adaptées à chaque organisation.", features: ["Audit de sécurité et tests d'intrusion (pentesting)", 'Analyse des vulnérabilités et gestion des risques', 'Mise en place de politiques de sécurité (RGPD, ISO 27001)', 'Sécurisation des applications web et mobiles', 'Protection contre les ransomwares et malwares', 'Authentification forte et gestion des accès (IAM)', 'Surveillance SOC et détection d\'intrusions (IDS/IPS)', 'Formation et sensibilisation des équipes', 'Réponse aux incidents et plan de reprise (PRA/PCA)'], technologies: ['Kali Linux', 'Metasploit', 'Burp Suite', 'Wireshark', 'Nessus', 'OWASP', 'Splunk', 'CrowdStrike'], category: 'securite', order: 10 }
      ]);
      console.log('✅ Services initialisés');
    } else {
      // Ensure cybersecurity service exists even if DB was already seeded
      const cyberExists = await Service.findOne({ id: 'cybersecurite' });
      if (!cyberExists) {
        await Service.create({ id: 'cybersecurite', title: 'Cybersécurité', subtitle: 'Protégez votre infrastructure numérique', icon: '<i class="fas fa-shield-halved"></i>', image: 'images/ia.jpg', shortDesc: 'Audit, protection et surveillance de vos systèmes informatiques contre les cybermenaces pour garantir la sécurité de vos données.', longDesc: "JUDDEV CORPORATION vous accompagne dans la sécurisation de votre infrastructure numérique. Notre équipe d'experts effectue des audits complets, identifie les vulnérabilités et met en place des mesures de protection robustes adaptées à chaque organisation.", features: ["Audit de sécurité et tests d'intrusion (pentesting)", 'Analyse des vulnérabilités et gestion des risques', 'Mise en place de politiques de sécurité (RGPD, ISO 27001)', 'Sécurisation des applications web et mobiles', 'Protection contre les ransomwares et malwares', 'Authentification forte et gestion des accès (IAM)', "Surveillance SOC et détection d'intrusions (IDS/IPS)", 'Formation et sensibilisation des équipes', 'Réponse aux incidents et plan de reprise (PRA/PCA)'], technologies: ['Kali Linux', 'Metasploit', 'Burp Suite', 'Wireshark', 'Nessus', 'OWASP', 'Splunk', 'CrowdStrike'], category: 'securite', order: 10 });
        console.log('✅ Service Cybersécurité ajouté');
      }
    }
